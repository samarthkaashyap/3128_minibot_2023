...
public class FunctionalCommand extends CommandBase {
  ...
  public FunctionalCommand(Runnable onInit, Runnable onExecute, Consumer<Boolean> onEnd,
    ...
    m_onInit = onInit;	//requireNonNullParam(onInit, "onInit", "FunctionalCommand");
    m_onExecute = onExecute;	//requireNonNullParam(onExecute, "onExecute", "FunctionalCommand");
    m_onEnd = onEnd;	//requireNonNullParam(onEnd, "onEnd", "FunctionalCommand");
    m_isFinished = isFinished;	//requireNonNullParam(isFinished, "isFinished", "FunctionalCommand");
