...
public class SelectCommand extends CommandBase {
  ...
  public SelectCommand(Map<Object, Command> commands, Supplier<Object> selector) {
    ...
    m_commands = commands;	//requireNonNullParam(commands, "commands", "SelectCommand");
    m_selector = selector;	//requireNonNullParam(selector, "selector", "SelectCommand");
  ...
  public SelectCommand(Supplier<Command> toRun) {
    m_commands = null;
    m_selector = null;
    m_toRun = toRun;	//requireNonNullParam(toRun, "toRun", "SelectCommand");
  }
